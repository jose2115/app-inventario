        ...
        return [
            {
                ...
                texto: '<div class="w-full block sm:flex justify-center px-2 h-auto bg-gray-200 py-4 font-sans "><div class=" sm:w-1/3 h-full"><img class="h-16 w-auto mb-4 " src="../../../assets/mariposa.png" alt="plchldr.co" /><p class="text-4xl font-semibold mb-3">Cuéntanos donde te gustaría que llegáramos</p><div class="w-full mb-3 flex "><a href="https://www.instagram.com/zonadeparqueopago/" target="_blank" rel="noopener noreferrer"><img class="h-8 w-auto mb-4 " src="../../../assets/iconos/instagram.png" alt="plchldr.co" /></a><a href="https://www.facebook.com/ZonaDeParqueoPago" target="_blank" rel="noopener noreferrer"><img class="h-8 w-auto mb-4 " src="../../../assets/iconos/facebook.png" alt="plchldr.co" /></a><a href="https://twitter.com/ZonaParqueoPago" target="_blank" rel="noopener noreferrer"><img class="h-8 w-auto mb-4 " src="../../../assets/iconos/x.png" alt="plchldr.co" /></a></div><p class="text-2xl font-sans font-semibold mb-3">@Zonadeparquepago</p></div><div class=" sm:w-1/3 flex lg:justify-end "><img class="lg:w-3/4"  src="../../../assets/imagenes/qr.jpg"  style=" display: block;" /></div></div>',
                image: foto0,
                date:'18 mayo, 2023'
            }
        ];
