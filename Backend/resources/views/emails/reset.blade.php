...
<td class="card-cell" stylealqueria="box-sizing: border-box; background-color: rgb(255, 255, 255); overflow-x: hidden; overflow-y: hidden; border-top-left-radius: 3px; border-top-right-radius: 3px; border-bottom-right-radius: 3px; border-bottom-left-radius: 3px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-align: center;" bgcolor="rgb(255, 255, 255)" align="center">
<img src="https://www..com.co/sites/default/files/styles/1920_767/public/2022-07/banner-home-desktop-100-porciento-leche-min.png?h=d464d9b4&itok=4uVwKt7c.png" alt="Big image here" class="c1271" style="box-sizing: border-box; width: 100%; margin-top: 0px; margin-right: 0px; margin-bottom: 15px; margin-left: 0px; font-size: 50px; color: rgb(120, 197, 214); line-height: 250px; text-align: center;">
...
<h1 class="card-title" style="box-sizing: border-box; font-size: 25px; font-weight: 300; color: rgb(68, 68, 68);">Cambio de contraseña!
</h1>
<p class="card-text" style="box-sizing: border-box;">
    {{ $name }}, has cambiado tu contraseña!.
</p>
